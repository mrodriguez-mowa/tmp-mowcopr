...
export default ({
  subheading = "Envíos SMS",
  heading = (
    <>
      Designed & Developed by <span tw="text-primary-500">Professionals.</span>
    </>
  ),
  description = "En nuestra plataforma podrá crear y enviar notificaciones transaccionales, campañas de publicidad y marketing, recordatorios y notificaciones en general a través de:",
  primaryButtonText = "Conoce nuestra plataforma",
  ...
  const defaultFeatures = [
    {
      Icon: BriefcaseIcon,
      title: "Largo",
      description: "Entregabilidad del 80%. Mayor interacción. Menor costo.",
      iconContainerCss: tw`bg-teal-300 text-teal-800`
    },
    {
      Icon: MoneyIcon,
      title: "Corto",
      description: "Entregabilidad del 98%. Menor interacción. Mayor costo.",
