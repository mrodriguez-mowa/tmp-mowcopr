...
import logo from "../../images/mowito.png";
...
const Image = tw.img`max-w-full w-auto h-[520px] rounded-t sm:rounded relative z-20`;
...
export default ({
  heading = "Campañas efectivas",
  description = "Nuestra plataforma de inteligencia artificial convierte la información en conocimiento específico, contamos con un bot que procesa gran cantidad de datos y reconoce patrones de respuesta automáticamente.",
  imageSrc = logo,
  imageDecoratorBlob = true,
  primaryButtonUrl = "https://app.contactahabilidad.com/MES/",
  primaryButtonText = "¡Conócenos!",
  buttonRounded = true,
  features = ["Más de 10 años de experiencia", "Amplia cartera de clientes que nos respaldan", "A la vanguardia tecnológica"],
  testimonial = {
    quote: "Facilitamos la comunicación de las empresas con sus clientes a través de plataformas inteligentes de negocio, autoadministrables y bidireccionales.",
    customerName: "Mowito",
    customerCompany: "Mowacorp"
  }
}) => {
  ...
  const navLinks = [
    ...
    <NavLinks key={2}>
      ...
      <PrimaryLink css={buttonRoundedCss} target="_blank" href="https://app.contactahabilidad.com/MES/">
        Plataforma
      </PrimaryLink>
    </NavLinks>
  ];
